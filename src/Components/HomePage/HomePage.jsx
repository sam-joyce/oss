      ...
      <>
        ...
        <section className={styles.welcome}>
          <div className={styles.innerText}>
            ...
            <p>We are a UK based company. We have been supporting our customers across the globe for over 20 years with their stainless steel and nickel alloy requirements.</p>
